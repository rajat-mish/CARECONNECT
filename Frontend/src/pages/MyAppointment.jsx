        ...
        {appointments.map((item) => (
          ...
          >
            ...
            <div className="flex flex-col gap-2 sm:items-end">
              {!item.cancelled && item.payment && <button className='text-sm text-stone-600 bg-indigo-50 text-center min-w-[160px] py-2 border rounded-md   cursor-pointer transition-all duration-300'>Paid</button>}
           {!item.cancelled && 
           !item.payment && <button onClick={()=>appointmentRazorpay(item._id)} className="text-sm text-stone-600 text-center min-w-[160px] py-2 border rounded-md hover:bg-primary hover:text-white cursor-pointer transition-all duration-300">
                Pay here
              </button>}   
             {!item.cancelled && <button onClick={()=>cancelAppointment(item._id)} className="text-sm text-stone-600 text-center min-w-[160px] py-2 border rounded-md hover:bg-red-600 hover:text-white cursor-pointer transition-all duration-300">
                Cancel appointment
              </button>} 
